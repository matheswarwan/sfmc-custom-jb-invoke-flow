/* eslint-disable */
// Generated by Wrangler by running `wrangler types deployment/cloudflare/worker-configuration.d.ts` (hash: 3b008f76881ab957f8f98d855d5699c0)
// Runtime types generated with workerd@1.20260907.1 2026-09-08
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	APP_ORIGIN: "https://sfmc-custom-jb-invoke-flow.mathes-btech.workers.dev";
	CONNECTIONS: DurableObjectNamespace<import("./entry").SalesforceConnection>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./entry");
		durableNamespaces: "SalesforceConnection";
	}
